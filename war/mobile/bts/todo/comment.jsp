...
<script type="text/javascript" src="/js/m/bts/todo/comment.js"></script>

<div class="widget">
	<dl class="detail">
		<dt class="dt">ステータス</dt>
		<dd class="dd"><select id="todo_status"></select></dd>
		
		<dt class="dt">コメント</dt>
		<dd class="dd">
			<textarea class="required-input" id="todo_comment"></textarea>
		</dd>
